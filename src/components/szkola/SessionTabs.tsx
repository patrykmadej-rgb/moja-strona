...
export const SESSION_TABS: { key: SessionTabKey; label: string; enabled: boolean }[] = [
  ...
  { key: "podroz", label: "Podróż", enabled: false },
  { key: "zakwaterowanie", label: "Zakwaterowanie", enabled: false },
  { key: "platnosci", label: "Płatności", enabled: false },
  { key: "koszty", label: "Koszty", enabled: false },
