    ...
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="mt-12 space-y-4">
        <a
          ...
          className="flex items-center gap-4 rounded-2xl border border-[#5C2D91]/15 bg-white p-6 transition-all hover:border-[#5C2D91]/40 hover:shadow-md dark:bg-neutral-900 dark:border-white/10 dark:hover:border-purple-400/30"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#EDE6F8] dark:bg-purple-900/30">
            <span className="text-[#5C2D91] dark:text-purple-400">✉</span>
          </div>
          <div>
      ...
      <div className="mt-12 rounded-2xl border border-[#5C2D91]/15 bg-[#EDE6F8] p-7 dark:bg-[#5C2D91]/10 dark:border-purple-400/20">
